...
namespace StudentConference2014.Themes
{
    /// <summary>
    ...
    public class MkThemeSelector : DependencyObject
    {
        ...
        private static void ApplyTheme(FrameworkElement targetElement, Uri dictionaryUri)
        {
            ...
            try
            {
                ...
                var existingDictionaries = (from dictionary in targetElement.Resources.MergedDictionaries.OfType<ThemeResourceDictionary>()
